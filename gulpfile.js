...
exports.default = series(clean, htmlInclude, scripts, styles, resources, images, svgSprites, htmlMinify, watchFiles)

exports.build = series(clean, htmlInclude, scripts, styles, resources, images, svgSprites, htmlMinify)
